...
import com.whelp.demo.services.EmployeeService;
...
public class EmployeeController {
    ...
    @PutMapping("/{id}")
    void updateEmployee(@PathVariable("id") Long id, @RequestBody @Valid CreateEmployeeRequestModel employeeDetails) {
